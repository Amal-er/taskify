...
//         <div
//           style={{
//             border: "3px dotted #3498db", // Change this line to create a dotted border
//             padding: "10px",
//             marginBottom: "10px",
//           }}
//         >
...
//               }}
//             >
//               <label className="settingsText custom-blue">Name:</label>
//               <input
...
//               }}
//             >
//               <label className="settingsText custom-blue">Username:</label>
//               <input
//                 className="custom-blue"
//                 type="text"
//                 name="username"
...
//               }}
//             >
//               <label className="settingsTex custom-blue">Phone No:</label>
//               <input
//                 className="custom-blue"
//                 type="tel"
//                 name="phone"
...
//             </button>
//             <button
//               onClick={() => onSave(tempData)} // Pass the edited data back to the parent component
//               style={{
...
function Modal({ onClose, onSave, initialData, onInputChange }) {
  const [tempData, setTempData] = useState({ ...initialData }); // Initialize with initialData
