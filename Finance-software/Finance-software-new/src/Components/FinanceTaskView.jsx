...
<table class="table align-middle mb-0 bg-white " >
    ...
    <tr className='text-dark'>
      ...
      <th><img src={msge}  onClick={handleChatbotToggle} className=" mb-4" style={{cursor:'pointer'}}/></th>
      <th><img src={book} className=" mb-4" style={{cursor:'pointer'}}/></th>
...
export default FinanceTaskView
