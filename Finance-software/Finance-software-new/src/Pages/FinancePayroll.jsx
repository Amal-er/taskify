...
const FinancePayroll = () => {
  ...
  const financePayslip = () => {
    navigate("/financepayslip");
  };
...
<img src={leftarrow} width={'20px'}/>
    ...
    <div className="container-fluid">
     ...
     <button className="btn btn-primary mt-3 d-flex justify-content-end" onClick={financePayslip}>
          Create payslip
        </button>
      </div>
    </div>
