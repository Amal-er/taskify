...
<div style={{ flexGrow: 1, padding: '30px 50px', }}>
                    <div className='table'>
                        ...
                        <MDBDropdown className='mt-3'>
                            ...
                            <MDBDropdownMenu>
                                <Link to={'/hrcomplsaletask'}><MDBDropdownItem link>Sales</MDBDropdownItem></Link>
                  ...
                  {showFilter && (
                    <div className="filter-dropdown">
                      <ul>
                       <a href='/hremployeesaletask' className='text-dark'> <li><input type="checkbox" /> Show All</li></a>
...
export default HrCompletedTaskSales;
