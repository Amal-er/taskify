...
const Bde = () => {
  ...
  const employees = [
    { id: 1, name: "Chance", profilePic: profilePic },
  ...
  const handleMoreClick = (employeeName) => {
    navigate("/employee/salestask", { state: { employeeName } }); // Navigate to SalesTask page with state
  };
  ...
  return (
    <div className="bde-background">
      <Container fluid className="p-4">
        <Row>
          <Col>
            <h2 className="mb-4">Sales Employee List</h2>
            <div>
              <Row>
