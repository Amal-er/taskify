...
<table class="table align-middle mb-0 bg-white " >
    ...
    <tr className='text-dark'>
      ...
      <th><img src={msge}  onClick={handleChatbotToggle} className=" mb-4"/></th>
      <th> <Link to={'/salesemployeetask'}><img src={book} className=" mb-4"/></Link></th>
...
export default AdminSaleTaskView
