        ...
        <div className='table'>
              ...
              <table className="table align-middle mb-0 bg-white">
                <thead className="bg-primary">
                  <tr className='text-white'>
                    ...
                    <th className='text-white'>Work Phone</th>
                    <th className='text-white'>Place of Supply</th>
                    <th className='text-white'>Receivable</th>
                    <th className='text-white'>Unused Credits</th>
                  </tr>
                </thead>
                <tbody>
                  {/* Example row */}
          ...
          <Link to={'/addnewclients'}>
            <div className="add-new-client-container">
              <button className="new-client bg-primary text-white">Add New Client</button>
            </div>
          </Link>
          ...
          {activeTab === 'invoice' && (
            <div className="invoice-section">
              ...
              <div className="create-invoice">
               ...
               <Link to={'/adminexistinginvoice'}> <button className="create-new-invoice bg-primary">
