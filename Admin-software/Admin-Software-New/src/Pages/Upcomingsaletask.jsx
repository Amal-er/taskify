...
<Header/>
 <div style={{ display: 'flex', flexDirection: 'row', height: '100vh',  }}>
  ...
  <Link to={'/upcomingtask'} ><img src={leftarrow} className="mb-2"/></Link>
<div className='table'>
  <h3>Upcoming Task Sales</h3>
<button type="button" className="btn " id="addnewbtn" onClick={handleAddTaskClick}>
<i class="fa-solid fa-plus me-1"></i>Add New Task</button> <br />
{showFileUpload && (
...
<MDBDropdownMenu>
<Link to={'/upcomingtask'}><MDBDropdownItem link>Software</MDBDropdownItem></Link>
...
<td>
<p class="fw-normal mb-1"><Link to={'/upcomingempsaletask'}><img src={book} className='me-1'/></Link><img src={message} className='me-1'  onClick={handleChatbotToggle} style={{cursor:'pointer'}}/>
...
export default UpcomingsaleTask
