...
import AdminSaleTaskView from '../Components/AdminSaleTaskView';
...
<i class="fa-solid fa-user me-2"></i>Add New Employee 
      ...
      <th className='text-light'>Employee Name</th>
      <th className='text-light'>Designation</th>
      <th className='text-light'>Mobile No</th>
      <th className='text-light'>Email ID</th>
      <th className='text-light'>Shift</th>
  ...
  {employees.slice(1).map((employee, index) => (
                  <React.Fragment key={index}>
                    <tr onClick={() => handleToggle(index)}>
                      ...
                      <Link to={'/newmail'}><td><img src={mail} className='me-1' alt="mail" />{employee.email}</td></Link>
                      <td>
