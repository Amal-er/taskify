...
<div style={{ flexGrow: 1, padding: '30px 40px' }} >
        <div className='table'>
          <h3 style={{ color: 'black' }}>Completed Task Sales</h3>
          <MDBDropdown className='btn-department'>
      <MDBDropdownToggle tag='a' className='text-dark'>
       Department
      </MDBDropdownToggle>
      <MDBDropdownMenu>
        <MDBDropdownItem link>Sales</MDBDropdownItem>
                ...
                <th style={{ position: 'relative' }}>
                  ...
                  {showFilter && (
                    <div className="filter-dropdown" style={{width:'120px'}}>
                      <ul>
                        <Link to={'/completedemployeetask'}><li className='text-dark'><input type="checkbox" /> Show All</li></Link>
  ...
  >
    Completed
                ...
                <td>
                  ...
                  <Link to ={'/completedemptask'}><img src={book} className='me-1 ms-2' alt="book" /></Link>
                </td>
              </tr>
              <tr>
                <td>
...
export default CompletedTaskSales
